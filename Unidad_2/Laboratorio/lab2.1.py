...
class CafeteriaUniversidad():
    """ ## Variables de clase ##
    1. A. los defino como variables de clase ya que son 'descuentos' que pueden ser cambiados, y de esta mannera es mejor ya que asi puedo cambiar los desdcuentos desde la misma clase sin tener q modifcar las instancis
    """
    ...
    def __init__(self,nombre,tipo,total,compra):
        ...
        self.__descuento = 0 # <-- creo q simplemente con una variable puedo simplemente almacenar el descuento afiliado al usario, con la diferencia de que es privada
        self.compra = compra
